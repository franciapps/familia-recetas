// Lista de compras semanales — base del Excel + staples fijos solicitados
// Staples fijos cada semana: yogurt Flor de Alfalfa 1kg, leche Lala Orgánica 2L,
//   8 plátanos, 12 manzanas, 10 tunas
// Fruta rotativa: S1=melón+uva, S2=sandía+kiwi, S3=papaya+uva+kiwi
...
export const SHOPPING = {
  1: [
    ...
    // Huevos / Lácteos
    { categoria: 'Huevos / Lácteos', articulo: 'Huevos Murlota', cantidad: '1 docena', precio: 75 },
    { categoria: 'Huevos / Lácteos', articulo: 'Parmesano reggiano', cantidad: '150 g', precio: 90 },
    { categoria: 'Huevos / Lácteos', articulo: 'Queso oaxaca La Huaxtequita', cantidad: '200 g', precio: 45 },
    ...
    { categoria: 'Verduras', articulo: 'Acelga (acelga)', cantidad: '1 manojo', precio: 20 },
  ...
  2: [
    ...
    { categoria: 'Carne / Pescado', articulo: 'Pescado blanco (huachinango o mojarra)', cantidad: '1 kg', precio: 280 },
    // Huevos / Lácteos
    { categoria: 'Huevos / Lácteos', articulo: 'Huevos Murlota', cantidad: '1.5 docenas', precio: 115 },
    { categoria: 'Huevos / Lácteos', articulo: 'Parmesano reggiano', cantidad: '100 g', precio: 60 },
    { categoria: 'Huevos / Lácteos', articulo: 'Queso oaxaca La Huaxtequita', cantidad: '200 g', precio: 45 },
    { categoria: 'Huevos / Lácteos', articulo: 'Queso panela La Huaxtequita', cantidad: '150 g', precio: 30 },
    { categoria: 'Huevos / Lácteos', articulo: 'Yogurt Flor de Alfalfa', cantidad: '1 kg', precio: 70 },
    { categoria: 'Huevos / Lácteos', articulo: 'Leche Lala Orgánica Blanca', cantidad: '2 L', precio: 55 },
    // Verduras
    { categoria: 'Verduras', articulo: 'Zanahorias', cantidad: '1.5 kg', precio: 30 },
  ...
  3: [
    // Carne / Pescado (S3: arrachera + pescado, sin pollo)
    { categoria: 'Carne / Pescado', articulo: 'Arrachera (falda de res)', cantidad: '800 g', precio: 240 },
    { categoria: 'Carne / Pescado', articulo: 'Pescado blanco (huachinango o mojarra)', cantidad: '1 kg', precio: 280 },
    // Huevos / Lácteos
    { categoria: 'Huevos / Lácteos', articulo: 'Huevos Murlota', cantidad: '2 docenas', precio: 150 },
    { categoria: 'Huevos / Lácteos', articulo: 'Parmesano reggiano', cantidad: '100 g', precio: 60 },
    { categoria: 'Huevos / Lácteos', articulo: 'Queso oaxaca La Huaxtequita', cantidad: '200 g', precio: 45 },
    { categoria: 'Huevos / Lácteos', articulo: 'Queso panela La Huaxtequita', cantidad: '300 g', precio: 55 },
    { categoria: 'Huevos / Lácteos', articulo: 'Yogurt Flor de Alfalfa', cantidad: '1 kg', precio: 70 },
    { categoria: 'Huevos / Lácteos', articulo: 'Leche Lala Orgánica Blanca', cantidad: '2 L', precio: 55 },
    // Verduras
    { categoria: 'Verduras', articulo: 'Champiñones', cantidad: '500 g', precio: 40 },
    { categoria: 'Verduras', articulo: 'Zanahorias', cantidad: '1 kg', precio: 20 },
    { categoria: 'Verduras', articulo: 'Calabacitas', cantidad: '1.5 kg', precio: 45 },
    { categoria: 'Verduras', articulo: 'Acelga (acelga)', cantidad: '3 manojos', precio: 60 },
...
export const PANTRY = [
  ...
  { categoria: 'Cereales / Pasta', articulo: 'Pasta Rummo (varios formatos)', cantidad: '1.5 kg', precio: 210 },
